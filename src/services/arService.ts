...
export class ARService {
  ...
  private baseUrl: string = 'https://us-central1-geo-ar-services.cloudfunctions.net/ar';
  ...
  async createARAnchor(asset: ARAsset): Promise<string> {
    try {
  ...
  generateCloudAnchorHTML(anchorId: string): string {
    return `
      <!DOCTYPE html>
      <html>
        <head>
